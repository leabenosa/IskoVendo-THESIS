...
import { useProducts, Product } from './src/Screens/ProductContext';
...
export default function AddProductScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // 2️⃣ Insert product into 'products' table
      ...
      if (productError || !productData) throw productError || new Error("Product insert failed");

      const productId = productData.id;

      // 3️⃣ Add product to inventory (using context)
...
const styles = StyleSheet.create({
  ...
  imageText: { fontSize: 16, color: "#777", fontWeight: "600" },
